(function () {
  ...
  var translations = {
    en: {
      ...
      'portfolio.item1.title': 'TATTOO SESSION',
      'portfolio.item1.sub': 'Short-form promotional video',
      'portfolio.item2.title': 'RESTAURANT',
      'portfolio.item2.sub': 'Short-form promotional video',
      'portfolio.item3.title': 'TATTOO ART',
      'portfolio.item3.sub': 'Short-form promotional video',
      'portfolio.item4.title': 'TATTOO STUDIO',
      'portfolio.item4.sub': 'Short-form promotional video',
      'portfolio.item5.title': 'HOTEL &amp; RESORT',
      'portfolio.item5.sub': 'Promotional video',
      'portfolio.item6.title': 'WINE SHOP',
